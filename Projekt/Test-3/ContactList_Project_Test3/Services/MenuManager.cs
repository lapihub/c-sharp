...
public class MenuManager : IMenuManage
{
    ...
    public void UpdateMenu()
    {
        ...
        {
            Console.Clear();
            Console.WriteLine($"Kunde inte hitta någon kontakt med e-postadress <{email}>. Ingen ängring gjordes.");
        }
        Console.ReadKey();
    }
    ...
    public void DeleteMenu()
    {
        ...
        if (contact != null)
        {
            ...
            try
            {
                _contactManager.DeleteContact(new string(email));
            }
            catch { }
    ...
    public void ListAllMenu()
    {
        ...
        {
            foreach (var contact in _contactManager.GetAll())
                if (contact != null)
                {
                Console.WriteLine($"{contact.FirstName} {contact.LastName} <{contact.Email}> {contact.PhoneNumber} - {contact.FullAddress.FullAddress}");
                }
